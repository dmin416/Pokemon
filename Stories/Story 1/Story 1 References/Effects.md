# Effects / Recipe Grade Guide

Rough Culinary Master appraisal rules for Story 1. Restaurant food gives no buffs — only D’s cooked (or juiced) dishes do. Early “January” meal stamps = **League 298** ([`Dates.md`](Dates.md) / [`Timeline.md`](Timeline.md)).

## Grade → effect tier

| Grade | Effect tier | Rough meaning |
|-------|-------------|----------------|
| **D and below** (D, D-, E, F…) | Little / none, or wild niche | Fills belly at best, or a bizarre exclusive (Steamed Chicken Feed F: Egg explosion). Bad seasoning can wipe bonuses. |
| **C** (incl. C- / C+) | **Level 1** | One weak buff (or a slight exclusive niche effect). Short duration. C- is thinner / shorter; C+ a bit stronger or longer. |
| **B** (incl. B- / B+) | **Level 2** | Mid buffs: “large” recovery/stat spikes, or several small effects together. Hour-scale duration is typical so far. |
| **A** (incl. A- / A+) | **Level 3** | Strong combat/ranch buffs. Longer duration and/or multiple strong effects. First A-band dish: Super Berry Platter (A-) Ch. 210. Exclusive lv3 also seen on Steamed Egg B+ (Slippery). |
| **S** (incl. S- / S+) | Permanent or equal power | Lasting change, or a temporary effect as strong as a permanent would be. Rare. Black Truffle Milk Porridge (S); Reversing Mask series (S); Storm Steamed Bun (S+). |
...
- Exclusive effects (e.g. bovine-only) still follow the grade tier for power unless the appraisal prints a higher lv (Berry Milk C ≈ slight / lv1 niche; Slippery lv3 on B+).
- Multiple effects on one dish still sit under that dish's grade cap (B steak = several mid-tier lines, not an A package).
- Non-food ingredients can cook: grass, metal, chicken feed, and (untested) stone. F-band can still carry strong ranch exclusives (Egg explosion, Chapter 27).
- Some dishes carry extra favorability lines for a named species (Spicy Iron Block → Heatran).

---

## Known dishes (by grade)

### D and below — little / none / wild niche
...
| Spicy Iron Block | D | Slight Fire/Steel energy control. Extra: Heatran favorability up (slight). Normal Pokémon cannot eat it. Ch. 22 |
| Cream Fruit Cake (Caramel Flavor) | D- | Sweet Dream **lv1**. Cook can see the dreams. Ch. 26–27 |
| Steamed Chicken Feed | F | Egg explosion (hens: burst laying then 15-day cooldown; roosters: faster fertilization). Not for humans. Ch. 27 |
| Ordinary rice porridge | E | Slight energy restore (mentioned Ch. 39; earlier unlogged cook) |
| Smashed Cucumber | D | Heat Resistance **lv1**. Ch. 54 |

### C — Level 1

| Dish | Grade | Effects |
|------|-------|---------|
| Hot Soup Noodles | C- | Cold Resistance **lv1**, 30 min. Ch. 3 |
...
| Grass Ball / Green Grass Dumplings | C | Grass-move comprehension (slight); Grass affection up (slight). Ch. 41–48 |
...
| Dish | Grade | Effects |
|------|-------|---------|
| Pan-Seared Pork Steak | B | Large HP recovery; large strength up; small EXP/insights; **60 min**. Ch. 8 |
| Glutinous Rice Ball | B | Bug-only Bug Silk Enhancement **lv1–lv3** (balls vary). Confirmed on Caterpie (lv3). Ch. 11–12 |
| Grilled Rainbow Trout | B | Life Recovery (Extra Large); peak vitality/energy. Ch. 16 |
| Steamed Egg | B+ | Slippery **lv3** (hairless only), 3 hours. Extra: Stamina Recovery. Ch. 26. Party stall item Ch. 56–58 |
| Milk Porridge | B | Better Milk **lv1** (milk-producers only); energy restore. Ch. 39 |
...
| Dish | Grade | Effects |
|------|-------|---------|
| Fragrant Sweet Poffin | A | Good Friend **lv2**. Ch. 71 |
| Lucky Pudding | A | Temporary good fortune / rare-item find up. Ch. 77 |
...
## Effect catalog (confirmed)

### Cold Resistance lv1

- Tier: Level 1 (C-band)
- Hot Soup Noodles C- (30 min) / C (35 min)
- Helps endure severe cold; body feels warm
- Confirmed: Cyclizar

### Cold Resistance lv3

- Tier: Level 2 package on Hot Noodle Soup (B+)
- Duration: **6 hours**
- Full ingredients and seasonings (Ch. 109). Same dish line as early Hot Soup Noodles
- Confirmed: D and Koraidon on Glaseado approach

### Stamina Recovery (Large)

- Honey Grilled Fish (Ch. 101). Side cook while making gummies

### Revitalization

- Honey Lemon Water (Ch. 101). Relieves fatigue; restores energy

### Large HP recovery

- Tier: Level 2 (B-band)
- Pan-Seared Pork Steak (B), 60 min with other steak buffs
- Confirmed: Cyclizar, Koraidon

### Large strength increase

- Tier: Level 2 (B-band)
- Pan-Seared Pork Steak (B), 60 min
- Confirmed: Cyclizar, Koraidon

### Small EXP and insights

- Tier: Level 2 package (secondary on B steak)
- Pan-Seared Pork Steak (B), 60 min
- Confirmed: Cyclizar, Koraidon

### Bovine milk quality up (slight)

- Tier: Level 1 niche (C-band)
- Berry Milk (C)
- Exclusive to bovine Pokémon. Miltank ×3 on ranch from Ch. 85–94; Top MooMoo path used Black Truffle Milk Porridge (S) instead (Ch. 86–92)
...
- Tier: unrated dish (Ch. 10)
- Cold Cucumber Slices
- Beats the heat; body feels cool after eating

### Body warming

- Tier: unrated dish (Ch. 14)
- Warming Hot Juice
- Caterpie felt warmer after drinking

### Bug Silk Enhancement (lv1–lv3)

- Tier: Level 2 package (B-band); level on the silk buff varies per ball
- Glutinous Rice Ball (B)
- Bug-type exclusive; tougher / stronger Bug Silk
- Confirmed: Caterpie after lv3 ball — more silk volume; silk stretches instead of snapping (Ch. 12)

### Life Recovery (Extra Large)

- Tier: Level 2 (B-band)
- Grilled Rainbow Trout (B)
- Instantly restores vitality and energy to peak (Max Potion + comprehensive PP vibe)
- Confirmed: Cyclizar, Koraidon (Ch. 16)

### Skill Refinement

- Tier: Level 1 band (C- dish) but outcome is RNG, not a fixed buff. B+ truffle version raises rare-move odds
- Berry Platter (C-) / Berry Platter (B+)
- After eating, a move may: level up, level down, be forgotten, specialize, or a new move may be learned
- Confirmed: Caterpie learned Electroweb (Ch. 16); Cyclizar learned Dragon Tail and kept other moves (Ch. 49); Dragonite learned Extreme Speed then forgot Dragon Tail on B+ platter (Ch. 51)
- D treats as high-risk. Dragonite stopped further gambles after the wipe and relearned Dragon Tail by practice
...
- Tier: C-band
- Tomato and Scrambled Eggs (C). Harvest lunch and party stall Ch. 54–58

### Blaze Burst

- Tier: B-band Fire exclusive
- Boiled Pork Slices (B)
- Moderately increases Fire-type energy short-term; slightly enhances Fire-move comprehension
- Confirmed: Cinderace spat fire then learned **Blast Burn** (Ch. 54–55); Rick's Litleo learned **Flame Charge** (Ch. 57). Non-Fire Dragonite got no move

### Grass-type move comprehension (slight)

- Tier: D-band (slight)
- Steamed Green Grass (D-)
- After eating, Grass-types have a slightly higher chance to comprehend Grass-type moves
- Not fed to anyone yet (Ch. 22); leftover dumped

### Fire/Steel energy control (slight)

- Tier: D-band (slight)
- Spicy Iron Block (D)
- Slightly improves control of Fire-type and Steel-type energy
- Extra: feeding Heatran slightly increases favorability
- Refused by Cyclizar and Koraidon (Ch. 22); unused short-term

### Stamina Recovery (Purifying Salt)

- Ingredient line, not a finished dish (Ch. 24)
- Garganacl Purifying Salt adds Stamina Recovery to dishes
- Sprinkled on an injured Pokémon, wounds heal at once
- Jar on hand; confirmed on fried pork cutlets, clear soup noodles, and Steamed Egg (Ch. 26)

### Sweet Dream lv1

- Tier: D-band (lv1 on a D- dessert)
- Cream Fruit Cake (Caramel Flavor) (D-)
...
- Tier: exclusive lv3 on a B+ dish
- Steamed Egg (B+)
- Hairless Pokémon only
- Body becomes smooth and shiny; easier to escape contact moves
- Duration: 3 hours
- Plus Stamina Recovery from Purifying Salt (Ch. 26)
- Cyclizar slurped a bowl without tasting it (Ch. 27)

### Egg explosion

- Tier: F-band exclusive (Steamed Chicken Feed)
- Roosters: accelerates fertilization of eggs
- Hens: many eggs in a short time, then 15-day cooldown (no laying, cannot eat this dish, need lots of food)
- Confirmed on one hen: ~20 eggs in ~1 minute (Ch. 27–28). Borrows the next 15 days of laying. Does not break the hen. Hen ate the whole trough.

### Sweet memory / energy restore (caramel Berry Milk)

- Tier: unrated (Ch. 30)
- Caramel-flavored Berry Milk (MooMoo Milk + Alcremie cream + berries)
- Reminds Pokémon of sweet, joyful events and restores energy
- Separate from Berry Milk (C) bovine line
- Confirmed: Arven's Mabosstiff (and Arven liked the taste)

### Better Milk lv1

- Tier: exclusive on Milk Porridge (B)
- Milk-producing Pokémon only
- Slightly enhances milk quality (tastier, more nutritious) plus energy restore
- Superseded in practice by Black Truffle Milk Porridge (S) Better Milk lv3 on Skiddo (Ch. 46)

### Better Milk lv3

- Tier: S-band exclusive on Black Truffle Milk Porridge (S)
- Milk-producing Pokémon only
- Significantly enhances milk quality (tastier, more nutritious) plus quick energy restore
- Black Truffle raised Milk Porridge (B) to S
- Fed to Skiddo (Ch. 46). Later milk appraises as **Goat Milk (Top Quality)**; Zack pays **600**/bottle (Ch. 50) then **800**/bottle (Ch. 83). Same porridge line on Miltank → Top MooMoo **600**/bottle (Ch. 86–92)

### Grass-move comprehension + Grass affection (slight)

- Tier: C-band (Grass Ball / Green Grass Dumplings)
- Slightly higher chance Grass-types comprehend Grass moves; slight Grass affection up
- Confirmed path: Skiddo binge → Grassy Terrain and Solar Beam (Ch. 48). Separate from Steamed Green Grass (D-)

### Health restore (Fried Pork Loin)

- Tier: C-band
- Fried Pork Loin (C). Fed to Cyclizar (Ch. 49)

### Dessert fondness up (Xue Mei Niang)

- Tier: B-band
- Greatly increases fondness of dessert-loving Pokémon; strong attraction to Alcremie (Ch. 49)

### Water-type attraction (carried)

- Tier: C+ band
- Lemon Sole Sandwich (C+): attracts Water-types when carried (Ch. 49). Not field-tested yet

### Good Friend lv2

- Tier: A-band on Fragrant Sweet Poffin (A)
- Sweet-liking friendliness up; helps attract wild sweet-likers; long-term can strengthen (Ch. 71)

### Temporary good fortune (Lucky Pudding A)

- Tier: A-band
- Short luck up for humans; Pokémon rare-item find chance up while active (Ch. 77)
- Extreme Luck on Black Truffle Caramel Honey Pudding (A+) is the stronger temporary line (Ch. 100)

### Fortune Accompanies (Lucky Pudding S)

- Tier: S-band permanent
- Permanent luck for humans and Pokémon; traveling Pokémon permanently raise rare Pickup odds (Ch. 101)
- Confirmed gift to Teddiursa. Remakes did not auto-hit S (Ch. 103)

### Bear attraction (Honey Bun)

- Tier: A- band
- Honey scent attracts some Bear-types (Ch. 94)

### Birthday gift (+1 all stats)

- Tier: B-band permanent
- Birthday Cake (B): permanent +1 HP / Atk / SpA / Spe / Def / SpD (Ch. 95)

### Run Away (Honey Gummies)
...
- Tier: B- band niche
- Consciousness “sees” Giratina’s Reversed World; body still moves in the real world (Indeedee Psychic spotting). Cannot take objects out without a true entry / Giratina gateway. Detox with Pecha Berry Juice or Antidote on a short timer (about 15 minutes in practice). Ch. 200–203

### Reversing the Universe (Reversing Mask)

- Tier: S-band; requires **Water of the Reversed World**
- Heart: nature reverse. Techniques: Legendary ability / aura / authority reverse. Body: physical power reverse
- Temporary soft luminous form on Giratina after Heart + Techniques (Ch. 204). Effect fades for the realm’s master

### Sea God (1/6)

- Tier: S+ incomplete on Storm Steamed Bun
- Weather control; Flying exclusive. Ratio loss from wasted Lugia powder. Six buns still gave Dragonite storm-scale Rain Dance and opened the path to Aeroblast (Ch. 207–208)

### Skill Refinement (large)
